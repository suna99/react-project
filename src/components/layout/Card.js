      ...
      <div className="card__inner container">
        <article className="card">
          ...
          <div className="card__body">
            <h3 className="tit">이달의 썹!프라이즈</h3>
            <p className="desc">
              이달의 썹!프라이즈로 로티세리 바베큐 샌드위치 15cm + 음료 16oz가
              7,600원입니다. 본 프로모션은 9월 1일부터 10월 31일까지 진행되며
              매장 구매 및 Fast-Sub 이용 시에만 적용 가능합니다! 프로모션 상품은
              1인당 최대 5개 구매 가능합니다.
            </p>
        ...
        <article className="card">
          <figure className="card__header">
            <img src="assets/img/card_bg02.jpg" alt="미트볼 판매 종료 안내" />
          </figure>
          <div className="card__body">
            <h3 className="tit">써브웨이 클래식</h3>
            <p className="desc">
              잘 나가는거 이탈리안 B.M.T, 추천하는 거 써브웨이 클럽!
        ...
        <article className="card">
          ...
          <div className="card__body">
            <h3 className="tit">버섯이 왔썹!</h3>
            <p className="desc">
              버섯이 왔썹! 머쉬룸 샐러드와 머쉬룸 썹을 즐겨보세요! 머쉬룸은 기간
